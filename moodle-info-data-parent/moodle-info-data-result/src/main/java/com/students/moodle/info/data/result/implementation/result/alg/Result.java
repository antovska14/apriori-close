...
public class Result implements ResultAlg{
	
	public String getResultFile(TransactionTable tt) throws IOException {
	...
	private void writeToFile(List<List<Integer>> transactionTable, String fileName) throws IOException {
